...
public final class EnumsList {
    
    public static final int CONNECTIVITY_GOOD = 0;
    ...
    public static final int MUSIC_NOT_EXISTS = 8;
    public static final int MUSIC_EXISTS = 9;
